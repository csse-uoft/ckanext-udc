...
## Mapping multilingual fields to the graph database
The mapping can be done as usual in JSON-LD. Here are some examples of how to map multilingual fields to the graph database:
```json
{
    "mappings": {
        "@context": {
            ...
            "skos:prefLabel": [
                {
                  "@type": "xsd:string",
                  "@language": "en",
                  "@value": "{ckanField.theme.en}"
                },
                {
                  "@type": "xsd:string",
                  "@language": "fr",
                  "@value": "{ckanField.theme.fr}"
                }
            ]
        },
        "dct:title": [
            {
              "@type": "xsd:string",
              "@language": "en",
              "@value": "{ckanField.title.en}"
            },
            {
                "@type": "xsd:string",
                "@language": "fr",
                "@value": "{ckanField.title.fr}"
            }
        ]
    }
}
